...
class MAXWELL_FFT:
    def __init__(self, data_sampler, res_sampler, bc_sampler,
        ...
        # w_t_phys_list = [12.0, 8.0, 13.0, 11.0, 9.0, 14.0, 10.0, 7.0]
        w_t_phys_list = [12.0, 8.0, 13.0]
        k_x_phys_list = [3.0, 2.0]
...
if __name__ == '__main__':
    ...
    model = MAXWELL_FFT(data_sampler, res_sampler, bc_sampler,
                             ic_sampler,
                             layers, kernel_size)
...
########################################################### Plot #################################################
    ...
    # plt.savefig('maxwell_loss_history.png', dpi=300, bbox_inches='tight')
    # plt.close()
    # # plt.tight_layout()
    # # plt.show()
    #
    ...
    #
    # plt.axhline(y=mu_pred, color='r', linestyle=':', linewidth=2, alpha=0.7,
    #             label=f'True $\lambda_1$ = {mu_true}')
    # plt.axhline(y=eps_true, color='b', linestyle=':', linewidth=2, alpha=0.7,
    #             label=f'True $\lambda_2$ = {eps_true}')
    #
    # plt.xlabel('Iterations')
    ...
    # plt.savefig('maxwell_param_convergence.png', dpi=300, bbox_inches='tight')
    # plt.close()
    # # plt.tight_layout()
    # # plt.show()
    ...
    # grid_shape = E_full.shape
    #
    # E_exact = E_full_flat.reshape(grid_shape)
    # H_exact = H_full_aligned_flat.reshape(grid_shape)
    #
    # E_pred_plot = u_pred_full.reshape(grid_shape)
    # H_pred_plot = v_pred_full.reshape(grid_shape)
    #
    # # u(x,t)
    # fig = plt.figure(figsize=(18, 5))
    #
    # plt.subplot(1, 3, 1)
    # plt.pcolormesh(T_full, X_full, E_exact, cmap='jet', shading='auto')
    # plt.colorbar()
    # plt.xlabel('t')
    # plt.ylabel('x')
    # plt.title('Exact Solution E(x,t)')
    #
    # plt.subplot(1, 3, 2)
    # plt.pcolormesh(T_full, X_full, E_pred_plot, cmap='jet', shading='auto')
    # plt.colorbar()
    # plt.xlabel('t')
    # plt.ylabel('x')
    # plt.title('Predicted Solution E(x,t)')
    #
    # plt.subplot(1, 3, 3)
    # plt.pcolormesh(T_full, X_full, np.abs(E_exact - E_pred_plot), cmap='jet', shading='auto')
    # plt.colorbar()
    # plt.xlabel('t')
    # plt.ylabel('x')
    # plt.title('Absolute Error')
    # plt.savefig('maxwell_solution_E.png', dpi=300, bbox_inches='tight')
    # plt.close()
    #
    # # plt.tight_layout()
    # # plt.show()
    ...
    #
    # plt.subplot(1, 3, 1)
    # plt.pcolormesh(T_full, X_full, H_exact, cmap='jet', shading='auto')
    # plt.colorbar()
    # plt.xlabel('t')
    # plt.ylabel('x')
    # plt.title('Exact Solution H(x,t)')
    #
    # plt.subplot(1, 3, 2)
    # plt.pcolormesh(T_full, X_full, H_pred_plot, cmap='jet', shading='auto')
    # plt.colorbar()
    # plt.xlabel('t')
    # plt.ylabel('x')
    # plt.title('Predicted Solution H(x,t)')
    #
    # plt.subplot(1, 3, 3)
    # plt.pcolormesh(T_full, X_full, np.abs(H_exact - H_pred_plot), cmap='jet', shading='auto')
    # plt.colorbar()
    # plt.xlabel('t')
    # plt.ylabel('x')
    # plt.title('Absolute Error')
    # plt.savefig('maxwell_solution_H.png', dpi=300, bbox_inches='tight')
    # plt.close()
    #
    # # plt.tight_layout()
    # # plt.show()
