...
class Wave1D_FFT_NTK:
    ...
    def __init__(self, layers, operator, ics_sampler, bcs_sampler, res_sampler, data_sampler, kernel_size):
        ...
        w_t_phys_list = [29.850746, 49.751244, 50.746269, 30.845771, 48.756219, 28.855721]
        k_x_phys_list = [2.727273, 1.818182, 0.909091, 0.000000]
...
############################################ Plot ################################################
    ...
    #
    # plt.plot(model.iter_log, model.loss_log, 'b-', linewidth=2, label='Total Loss')
    # plt.plot(model.iter_log, model.loss_res_log, 'r--', linewidth=2, label='Residual Loss')
    # plt.plot(model.iter_log, model.loss_bcs_log, 'g--', linewidth=2, label='BCs Loss')
    # plt.plot(model.iter_log, model.loss_data_log, 'm--', linewidth=2, label='Data Loss')
    # plt.plot(model.iter_log, model.loss_ut_ics_log, 'c--', linewidth=2, label='ICs Loss')
    #
    ...
    # plt.savefig('wave_loss_history.png', dpi=300, bbox_inches='tight')
    # plt.close()
    # # plt.show()
    ...
    # U_exact = u_full.reshape(Exact_full.shape)
    # U_pred_plot = u_pred_full.reshape(Exact_full.shape)
    #
    ...
    # plt.tight_layout()
    #
    # plt.savefig('wave_solution_comparison.png', dpi=300, bbox_inches='tight')
    # plt.close()
    #
    # # plt.tight_layout()
    # # plt.show()
    ...
    #
    # plt.subplot(1, 2, 1)
    # plt.plot(model.iter_log, model.b_log, 'r-', linewidth=2, label='Estimated b')
    # plt.axhline(y=2.0, color='r', linestyle='--', alpha=0.7, label='True b = 2.0')
    # plt.xlabel('Iterations')
    # plt.ylabel('b value')
    # plt.legend()
    # plt.grid(True, alpha=0.3)
    # plt.title('Parameter b Convergence')
    #
    # plt.subplot(1, 2, 2)
    # plt.plot(model.iter_log, model.c_log, 'b-', linewidth=2, label='Estimated c')
    # plt.axhline(y=20.0, color='b', linestyle='--', alpha=0.7, label='True c = 20.0')
    # plt.xlabel('Iterations')
    # plt.ylabel('c value')
    # plt.legend()
    # plt.grid(True, alpha=0.3)
    # plt.title('Parameter c Convergence')
    #
    # plt.savefig('wave_param_convergence.png', dpi=300, bbox_inches='tight')
    # plt.close()
    #
    # # plt.tight_layout()
    # # plt.show()